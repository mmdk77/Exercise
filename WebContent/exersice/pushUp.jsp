...
<script>
	...
	function drawChart() {
		...
		var data = google.visualization.arrayToDataTable([
				[ 'Year', '과거', '현재', '목표치' ], [ '2014', 10, 400, 200 ],
				[ '2015', 1170, 460, 250 ], [ '2016', 660, 1120, 300 ],
				[ '2017', 1030, 540, 350 ], [ '2018', 100, 340, 2000 ]

		]);
		var data1 = google.visualization.arrayToDataTable([
				[ 'Months', '과거', '현재', '목표치' ], [ '1월', 100, 400, 200 ],
		...
		var data2 = google.visualization.arrayToDataTable([
				[ 'Days', '과거', '현재', '목표치' ], [ '1일', 1170, 460, 250 ],
				[ '2일', 660, 1120, 300 ], [ '3일', 1030, 540, 350 ],
				[ '4일', 100, 340, 2000 ], [ '5일', 100, 340, 2000 ],
				[ '6일', 100, 340, 2000 ], [ '7일', 100, 340, 2000 ],
				[ '8일', 100, 340, 2000 ], [ '9일', 100, 340, 2000 ],
				[ '10일', 100, 340, 2000 ],
